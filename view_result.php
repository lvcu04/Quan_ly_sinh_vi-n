...
<head>
    ...
    <title>Quản lý điểm số và học tập </title>
...
<body>
    ...
    <div class="content ">
        <center >
        <div class="jumbotron text-center my-8 py-4 "> <h1>Quản lý điểm số và học tập</h1></div>
    ...
    <div class="row my-1 py-2 mx-1 px-3 bg-custom align-items-center">
        <div class="col-md-4 ">
            ...
            <div class="btn btn-info ml-2">
                <button class="btn btn-info btn-sm float-right " id="view_result">Hiển thị kết quả</button>
            </div> 
        </div>
        <div class="col-md-4 ">
            
            <div class="btn btn-warning ml-2">
                <button class="btn btn-warning btn-sm float-right " id="add_result">Thêm kết quả học tập</button>
            </div> 
        </div>
    <div class="col-md-4">
